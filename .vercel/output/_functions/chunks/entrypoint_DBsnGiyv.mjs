import { R as ROUTE_TYPE_HEADER, q as REROUTE_DIRECTIVE_HEADER, A as AstroError, u as i18nNoLocaleFoundInPath, v as ResponseSentError, w as MiddlewareNoDataOrNextCalled, x as MiddlewareNotAResponse, y as RewriteWithBodyUsed, z as originPathnameSymbol, G as GetStaticPathsRequired, B as InvalidGetStaticPathsReturn, C as InvalidGetStaticPathsEntry, H as GetStaticPathsExpectedParams, J as GetStaticPathsInvalidRouteParam, P as PageNumberParamNotFound, K as decryptString, O as createSlotValueFromString, Q as isAstroComponentFactory, r as renderTemplate, a as renderComponent, D as DEFAULT_404_COMPONENT, S as NoMatchingStaticPathFound, T as PrerenderDynamicEndpointPathCollide, V as ReservedSlotName, W as renderSlotToString, X as renderJSX, Y as chunkToString, Z as isRenderInstruction, _ as ForbiddenRewrite, $ as SessionStorageSaveError, a0 as SessionStorageInitError, a1 as LocalsReassigned, a2 as AstroResponseHeadersReassigned, a3 as PrerenderClientAddressNotAvailable, a4 as clientAddressSymbol, a5 as ClientAddressNotAvailable, a6 as StaticClientAddressNotAvailable, a7 as ASTRO_VERSION, a8 as responseSentSymbol$1, a9 as renderPage, aa as REWRITE_DIRECTIVE_HEADER_KEY, ab as REWRITE_DIRECTIVE_HEADER_VALUE, ac as renderEndpoint, ad as LocalsNotAnObject, ae as REROUTABLE_STATUS_CODES } from './astro/server_DGjQ4oXc.mjs';
import { serialize, parse } from 'cookie';
import { bold, red, yellow, dim, blue } from 'kleur/colors';
import { g as getActionQueryString, d as deserializeActionResult, D as DEFAULT_404_ROUTE, a as default404Instance, N as NOOP_MIDDLEWARE_FN, e as ensure404Route } from './astro-designed-error-pages_BypWjtyo.mjs';
...
function createRequest({
  ...
  const headersObj = isPrerendered ? undefined : headers instanceof Headers ? headers : new Headers(
...
function generatePaginateFunction(routeMatch, base) {
  return function paginateUtility(data, args = {}) {
    ...
    const result = [...Array(lastPage).keys()].map((num) => {
      ...
      const next = pageNum === lastPage ? undefined : addRouteBase(routeMatch.generate({ ...params, page: String(pageNum + 1) }), base);
      const prev = pageNum === 1 ? undefined : addRouteBase(
        routeMatch.generate({
          ...params,
      ...
      const first = pageNum === 1 ? undefined : addRouteBase(
        routeMatch.generate({
          ...params,
      ...
      const last = pageNum === lastPage ? undefined : addRouteBase(routeMatch.generate({ ...params, page: String(lastPage) }), base);
      return {
        params,
        props: {
          ...additionalProps,
